(function (chaiModule) {
  ...
  function assertSomething() {
    ...
    if (!utils.flag(this, "contains") && !utils.flag(somethingFlags, "contains"))
    ...
    // The assertion's object for `something` should be enumerable and non-empty
  ...
  methodNames.forEach(function (methodName) {
    ...
    Assertion.overwriteMethod(methodName, function (_super) {
      return function somethingMethod() {
        ...
        if(methodName.match(/keys?/) && somethingFlags) {
          if (utils.flag(this, "negate") || utils.flag(somethingFlags, "negate"))
            utils.flag(this, "negate", true);
          if (utils.flag(this, "contains") || utils.flag(somethingFlags, "contains"))
            utils.flag(this, "contains", true);

          utils.flag(this, "any", true);
          utils.flag(this, "something", false);
          utils.flag(this, "all", false);
        ...
        // `include` or `contains` should have been called before
        if (!utils.flag(somethingFlags, "contains"))
          throw new Error("cannot use something without include or contains");
    ...
    Assertion.overwriteMethod(methodName, function (_super) {
      return function allMethod() {
        ...
        // passthrough keys assertion
        if(methodName.match(/keys?/) && allFlags) {
          if (utils.flag(this, "negate") || utils.flag(allFlags, "negate"))
            utils.flag(this, "negate", true);
          if (utils.flag(this, "contains") || utils.flag(allFlags, "contains"))
            utils.flag(this, "contains", true);

          utils.flag(this, "all", true);
          utils.flag(this, "any", false);
  ...
  ["something", "thing", "item", "one", "some", "any"].forEach(function (methodName) {
    if (!(methodName in assertionPrototype) || methodName == "any") // Always overwrite now
